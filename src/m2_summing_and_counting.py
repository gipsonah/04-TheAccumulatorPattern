...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -.02358184627  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(0, 5)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = -1.541603216 # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(3, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
...
def run_test_count_sines_from():
    ...
    # Test 6:
    expected = 1
    answer = count_sines_from(0, 1)
    print('Test 6 expected:', expected)
    print('         acutal:', answer)

    # Test 7:
    expected = 14
    answer = count_sines_from(0, 20)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 3:
    expected = 1000
    answer = count_sines_vs_cosines(1000)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    ...
    # Test 7:
    expected = 157
    answer = count_sines_vs_cosines(156)
    print('Test 7 expected:', expected)
    print('       actual:  ', answer)
